...
class DataProcessor:
    ...
    def remove_inventory():
        """ Function to manage removal of items from table in memory
            ...
            Returns: 
                prints 'The CD was removed', and displays current inveotry with item deleted
                """
        intRowNr = -1
        blnCDRemoved = False
        for row in lstTbl:
    ...
    def Write2Mem(userInput, dictionary, table):
...
class IO:
    ...
    def addCD(userInput1, userInput2, userInput3):
        """ Process user input to add data 
        
        Args: 
            userInput1: The ID of the CD
            userInput2: The Title of the CD
            userInput3: The Artist of the CD
        Returns: I feel like this should say more than "None"... but not sure what
        """
...
while True:
    ...
    # 3.3 process add a CD
        ...
        (strID,strTitle,stArtist) = IO.addCD(strID,strTitle,stArtist)
        # 3.3.2 Add item to the table
        DataProcessor.Write2Mem(intID,dicRow,lstTbl)
        IO.show_inventory(lstTbl)
        continue  # start loop back at top.
    ...
    # 3.5 process delete a CD
        ...
        DataProcessor.remove_inventory()
        IO.show_inventory(lstTbl)
        continue  # start loop back at top.
